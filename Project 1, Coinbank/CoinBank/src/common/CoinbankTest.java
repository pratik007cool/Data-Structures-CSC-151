...
public class CoinbankTest {
	...
	@Test // testing remove for valid coinType
	public void testRemove_validCoin()
	{
		Coinbank c = makeBank(4,1,3,5);
		assertEquals(4,c.remove(1,4));
		assertEquals(1,c.remove(5,1));
		assertEquals(3,c.remove(10,3));
		assertEquals(5,c.remove(25,6));
	}
	...
	public void testRemove_invalidCoin() {
		...
		assertEquals(0, c.remove(9, 4));
		assertEquals(0, c.remove(-1, 1));
	}

	@Test // testing for invalid coin requested
	public void test_RequestedCoin(){
		Coinbank c = makeBank( 4,3,2,1);
		assertEquals(0, c.remove(1, -1));
		assertEquals(0, c.remove(1, 0));
	}
